...
function [f,E]=S(t,Q)  // sistema de EDOs 
    ...
    // Retorno do lado direito do sistema de EDOs
    f(1)= Q(2,1);              
    f(2)= D;
...
nt = size(t,2)
for i=1:size(t,2)
    [lixo,E]=S(t(i),Q(:,i));             // pega a estrutura E
